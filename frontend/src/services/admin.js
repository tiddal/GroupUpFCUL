...
export default {
  ...
  edit: {
    ...
    class_: async (class_, class_number, course_code, unit_code) => {
      try {
        const response = await API.put(
          `courses/${course_code}/units/${unit_code}/classes/2019-2020/${class_number}`,
          { class: class_ }
        );
        return [response.data, response.status];
      } catch ({ response }) {
  ...
  remove: {
    ...
    class_: async (class_number, course_code, unit_code) => {
      try {
        const response = await API.delete(
          `courses/${course_code}/units/${unit_code}/classes/2019-2020/${class_number}`
        );
